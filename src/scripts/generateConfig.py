...
input('Copy agency ID into config.py and enter (y) when ready to continue: ')
os.system('cls' if os.name == 'nt' else 'clear')
...
input('Copy selected routes into routeInfo.py (allRoutes) and enter (y) when ready to continue: ')
os.system('cls' if os.name == 'nt' else 'clear')

gd.getStops(agencyID, routes)
input('Copy selected routes into routeInfo.py (routeMap) and enter (y) when ready to continue: ')
os.system('cls' if os.name == 'nt' else 'clear')
